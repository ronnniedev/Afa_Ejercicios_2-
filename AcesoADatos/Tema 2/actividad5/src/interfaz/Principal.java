...
public class Principal {
	 ...
	 */
	private int pedirEntero(String mensaje) throws NumberFormatException, IOException {
		try {
	 ...
	 */
	private void altaCliente() throws ExcepcionExamen, LogicaException {
	 ...
	 * 
	 */
	private void alquilarVideo() throws NumberFormatException, IOException, ExcepcionExamen {
	 ...
	 * @throws ExcepcionExamen 
	 */
	private void devolverVideo() throws NumberFormatException, IOException, ExcepcionExamen {
		System.out.println("Lista de clientes:\n\n" + sistema.listarClientes());
		System.out.println("Lista de videos:\n\n"+sistema.listarVideos());
		String dni = pedirString("Introduce el dni:");
		int codigo = pedirEntero("Intriduce el codigo del libro:");
